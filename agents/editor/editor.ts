...
export const createCodeEditor = (options: {
  ...
  return {
    ...
    toolNames: ['read_files', 'read_outline', 'read_blocks', 'edit_transaction'],
...
- Before the first edit to a large file, prefer read_blocks (windows/around/symbols) to mint complete cap.v3 blocks; use read_files ranges only for an exact arbitrary line range. Pass basedOnRead / readCapability from that read on the edit; never invent same-step sticky authority.
