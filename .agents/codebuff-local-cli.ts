...
const baseDefinition = createCliAgent({
  ...
  displayName: 'Openbuff Local CLI',
  cliName: 'Openbuff',
...
- If the current session becomes clearly unusable, report that failure; do not silently start a replacement session and continue as though nothing happened.`,
  spawnerPromptExtras: `**Purpose:** E2E visual testing of the Openbuff CLI itself. This agent starts a local dev Openbuff CLI instance and interacts with it to verify UI behavior.
