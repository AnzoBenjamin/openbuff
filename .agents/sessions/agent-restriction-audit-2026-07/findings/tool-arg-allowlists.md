...
## [LOW] test-coverage — agents/__tests__/security-glob-parity.test.ts:97 — [C] security-glob-parity test enforces doc/matcher sync — keep
...
- agents/__tests__/security-glob-parity.test.ts
