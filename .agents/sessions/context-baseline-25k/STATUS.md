...
**Predecessor** `.agents/sessions/context-budget-architecture-2026-08/` remains complete for ledger/`/context`/disclosure *flag*/proactive cache/git gate/compaction/lifecycle. This program hits **≤30k fixed** (stretch 25k) without weakening the gate.
