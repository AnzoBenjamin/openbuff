...
const PLATFORM_TARGETS = {
  ...
  'darwin-x64-legacy': `${packageName}-darwin-x64-legacy.tar.gz`,
  'darwin-arm64-legacy': `${packageName}-darwin-arm64-legacy.tar.gz`,
...
function assertSupportedPlatform() {
  ...
  if (major < MIN_LEGACY_MACOS_MAJOR) {
    ...
    console.error('Upgrade macOS, then reinstall or run codecane again.')
    console.error('')
    process.exit(1)
  }
