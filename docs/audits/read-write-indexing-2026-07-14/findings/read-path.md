...
## [MEDIUM] test coverage gaps — packages/agent-runtime/src/**tests**/process-str-replace.test.ts:1427 — Safety invariants are tested locally but not across authority boundaries
